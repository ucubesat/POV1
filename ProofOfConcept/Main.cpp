...
#include <ProofOfConcept/Top/ProofOfConceptTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
static void signalHandler(int signum) {
    ProofOfConcept::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    ProofOfConcept::TopologyState inputs;
    ...
    ProofOfConcept::setupTopology(inputs);
    ProofOfConcept::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    ProofOfConcept::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
