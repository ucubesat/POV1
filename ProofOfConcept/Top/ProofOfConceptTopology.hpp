// ======================================================================
// \title  ProofOfConceptTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef PROOFOFCONCEPT_PROOFOFCONCEPTTOPOLOGY_HPP
#define PROOFOFCONCEPT_PROOFOFCONCEPTTOPOLOGY_HPP
// Included for access to ProofOfConcept::TopologyState and ProofOfConcept::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <ProofOfConcept/Top/ProofOfConceptTopologyDefs.hpp>

// Remove unnecessary ProofOfConcept:: qualifications
 ...
 * ProofOfConcept::TopologyState see: ProofOfConceptTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type ProofOfConcept::TopologyState see: ProofOfConceptTopologyDefs.hpp.
 *
