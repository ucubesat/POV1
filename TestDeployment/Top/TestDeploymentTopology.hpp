// ======================================================================
// \title  TestDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef TESTDEPLOYMENT_TESTDEPLOYMENTTOPOLOGY_HPP
#define TESTDEPLOYMENT_TESTDEPLOYMENTTOPOLOGY_HPP
// Included for access to TestDeployment::TopologyState and TestDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <TestDeployment/Top/TestDeploymentTopologyDefs.hpp>

// Remove unnecessary TestDeployment:: qualifications
 ...
 * TestDeployment::TopologyState see: TestDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type TestDeployment::TopologyState see: TestDeploymentTopologyDefs.hpp.
 *
