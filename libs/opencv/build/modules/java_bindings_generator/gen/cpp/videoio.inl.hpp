...
#include "/home/agilsoul/FPrime-Projects/POV-1/libs/opencv/opencv-4.x/modules/videoio/include/opencv2/videoio.hpp"
#include "/home/agilsoul/FPrime-Projects/POV-1/libs/opencv/opencv-4.x/modules/videoio/include/opencv2/videoio/registry.hpp"
...
JNIEXPORT jlong JNICALL Java_org_opencv_videoio_VideoCapture_VideoCapture_17 (JNIEnv*, jclass, jlong, jint, jlong);

JNIEXPORT jlong JNICALL Java_org_opencv_videoio_VideoCapture_VideoCapture_17
  (JNIEnv* env, jclass , jlong source_nativeObj, jint apiPreference, jlong params_mat_nativeObj)
{
    ...
    try {
        ...
        Mat& params_mat = *((Mat*)params_mat_nativeObj);
        Mat_to_vector_int( params_mat, params );
        Ptr<cv::VideoCapture> _retval_ = makePtr<cv::VideoCapture>( *((Ptr<cv::IStreamReader>*)source_nativeObj), (int)apiPreference, params );
        return (jlong)(new Ptr<cv::VideoCapture>(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
...
JNIEXPORT jboolean JNICALL Java_org_opencv_videoio_VideoCapture_open_16 (JNIEnv*, jclass, jlong, jlong, jint, jlong);

JNIEXPORT jboolean JNICALL Java_org_opencv_videoio_VideoCapture_open_16
  (JNIEnv* env, jclass , jlong self, jlong source_nativeObj, jint apiPreference, jlong params_mat_nativeObj)
{
    ...
    try {
        ...
        Mat_to_vector_int( params_mat, params );
        Ptr<cv::VideoCapture>* me = (Ptr<cv::VideoCapture>*) self; //TODO: check for NULL
        return (*me)->open( *((Ptr<cv::IStreamReader>*)source_nativeObj), (int)apiPreference, params );
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
        throwJavaException(env, 0, method_name);
