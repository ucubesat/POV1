...
#include <SolarPanelProof/Top/SolarPanelProofTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
static void signalHandler(int signum) {
    SolarPanelProof::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    SolarPanelProof::TopologyState inputs;
    ...
    SolarPanelProof::setupTopology(inputs);
    SolarPanelProof::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    SolarPanelProof::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
