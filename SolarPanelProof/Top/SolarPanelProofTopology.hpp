// ======================================================================
// \title  SolarPanelProofTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef SOLARPANELPROOF_SOLARPANELPROOFTOPOLOGY_HPP
#define SOLARPANELPROOF_SOLARPANELPROOFTOPOLOGY_HPP
// Included for access to SolarPanelProof::TopologyState and SolarPanelProof::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <SolarPanelProof/Top/SolarPanelProofTopologyDefs.hpp>

// Remove unnecessary SolarPanelProof:: qualifications
 ...
 * SolarPanelProof::TopologyState see: SolarPanelProofTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type SolarPanelProof::TopologyState see: SolarPanelProofTopologyDefs.hpp.
 *
